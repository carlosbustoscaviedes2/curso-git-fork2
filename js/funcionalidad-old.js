if($(window).width() < '600') {
		...
		podcast.click(function(event) {
			...
			$("#audios_ltsx").attr('src', 'https://www.eltiempo.com/infografias/2020/12/audios_YM/podcast.mp3');
			audio.play();
		...
		radiocuento.click(function(event) {
			...
			$("#audios_ltsx").attr('src', 'https://www.eltiempo.com/infografias/2020/12/audios_YM/radiocuento.mp3');
			audio.play();
	...
	$("#libro_casa, #libro_casa_M").click(function(event) {
